...
import image from '/images/AboutUs/About/About.jpg';
        ...
        <div className='about-us-home-page-container'>
          ...
          <div className='about-us-home-page-info-section'>
            ...
            <p className='about-us-home-page-info-about-us-para-1'>
              ...
              highest level of quality and safety when it comes to
              troubleshooting in every project we undertake.
            </p>
            <p className='about-us-home-page-info-about-us-para-2'>
              ...
              14001 & ISO 45001 certified company, we provide unique solutions
              by understanding every project is unique and ensure all the
